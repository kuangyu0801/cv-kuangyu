...
\item Developing C++ remote capabilities development  environment targeted for Ubuntu Linux on IBM z15 mainframe with \href{https://theia-ide.org/}{Eclipse Theia IDE}
\item  Deployed Codeready Workspace on an self-administered OpenShift Cluster Platform on zFyre for z/CECSIM team; configured, tested, and deployed tool stacks with integrated functionality (develop, build, test) w/ CMake, IntelliSense, CTest, GDB, GoogleTest
\end{rSubsection}
