...
{Database} & {SQL: DynamoDB | NoSQL: PostgreSQL, Firebase {\bf Web Technology} REST, HTTP, XML, SOAP, WSDL, HTML/CSS}  \\
{Cloud} & {AWS: EC2, Elastic Beanstalk, SQS, RDS, S3, ElastiCache | Google Cloud: Kubernetes Engine, Functions, Pub/Sub} \\
{Speaking} &  {German (intermediate), English (full professional), Chinese (native)}
\end{tabular}
