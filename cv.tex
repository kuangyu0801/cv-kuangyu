...
\headline{CS Graduate} % Your professional headline
...
\item Developed a "Subscriber" Java application which can subscribe energy data via REST API and receive UDP datagram from a publishing service by type and value.
